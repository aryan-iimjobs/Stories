...
//  IGStories
//
//  Created by iim jobs on 08/04/20.
//  Copyright © 2020 iim jobs. All rights reserved.
//

import UIKit

class ShowCaseModel: NSObject, NSCoding  {
    ...
    init(v2companyId: String, v2bannerUrl: String, v2jsonFilePath: String, v2templateType: String, v2showcaseId: String, v2companyName: String, v2bannerBtnTxt: String) {
